...
namespace StoreProject.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(StoreProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            //var sh = reader["shipped_date"] == null ||
            //  reader["shipped_date"] == DBNull.Value ? null : Convert.ToDateTime(reader["shipped_date"]);   
            //var query = _context.Order.Where(e => e.ShippedDate == null);
            //if (query)
            //{
            //    
            //}
